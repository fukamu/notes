...
| SEC-AUTH-03 | Derive Account/Vault from the resolved session, never request content.                        | `backend/internal/identity/boundary_test.go`, `backend/internal/httpapi/session_context_test.go`, `backend/internal/httpapi/sync_v2_test.go`, `backend/internal/runtimefoundation/foundation_test.go` |
...
| ID          | Required invariant                                                           | Automated evidence                                                                                                                                          |
| ----------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SEC-DATA-01 | Scope content, journal, metadata, and quota by session Vault.                | `backend/cmd/notes/main_integration_test.go`, `backend/tests/integration/sync_v2_application_test.go`, `backend/tests/integration/encrypted_object_test.go` |
...
| SEC-DATA-04 | Bind encrypted data to Vault, object, revision, crypto version, and DEK.     | `backend/cmd/notes/main_integration_test.go`, `backend/internal/cryptocontent/model_test.go`, `backend/tests/integration/encrypted_object_test.go`          |
