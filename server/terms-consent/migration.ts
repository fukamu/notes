import type { MigrationDefinition } from '../migrations/core.ts';

export const termsConsentLedgerStatements = [
  ...
  'CREATE UNIQUE INDEX idx_terms_consent_submission ON terms_consent_evidence(account_id, vault_id, submission_id)',
  'CREATE INDEX idx_terms_consent_latest ON terms_consent_evidence(account_id, vault_id, accepted_at, consent_id)',
...
export const termsConsentLedgerMigration: MigrationDefinition = {
  id: '0015_terms_consent_ledger',
  checksum:
    'sha256:ea8852ce5855b8f0e9ed60a6d53f7509c18c101725198bf495f744284ca683ab',
  statements: termsConsentLedgerStatements,
};
