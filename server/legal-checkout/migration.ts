...
export const contractEvidenceStatements = [
  ...
  'CREATE UNIQUE INDEX idx_contract_evidence_submission ON contract_evidence(account_id, vault_id, submission_id)',
  `CREATE TRIGGER contract_evidence_immutable
    BEFORE UPDATE ON contract_evidence
    FOR EACH ROW
    BEGIN
      SELECT RAISE(ABORT, 'contract evidence is immutable');
    END`,
] as const;

export const contractEvidenceMigration: MigrationDefinition = {
  id: '0013_contract_evidence',
  checksum:
    'sha256:624517e4d712b98bb4d3cf38499ff64b69a569da9c31ab9f96addd948a637a15',
  statements: contractEvidenceStatements,
};
